					...
					if ((url.indexOf('infocompte=scriptOptions', 0)) >= 0) {
						...
						*/
						...
						function enregistreOption() {
							...
							for (var i = 0; i < document.getElementsByClassName('coul').length; i++) { document.getElementsByClassName('coul')[i].style.background = '#' + document.getElementsByClassName('coul')[i].value }
						...
						{ // ****************************** BBcode ouvrant/fermant *******************************
							...
							document.getElementById("copybbcode3").addEventListener("click", function (event) {
								...
								if (cellule.style.display == 'none') {
									...
									if (zoneCode != null) {
										zoneCode.style.display = 'none';
									}

									let zoneCode2 = document.getElementById('zonecode2');
									if (zoneCode2 != null) {
										zoneCode2.style.display = 'none';
									}
									let ifcTable = document.getElementById('IFC_table');
									if (ifcTable != null) {
										ifcTable.style.display = '';
									}
								}
								else {
									cellule.style.display = 'none';
